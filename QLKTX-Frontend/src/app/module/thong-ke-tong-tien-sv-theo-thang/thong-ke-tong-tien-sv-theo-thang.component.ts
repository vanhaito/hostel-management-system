...
@Component({
  selector: 'app-thong-ke-tong-tien-sv-theo-thang',
  templateUrl: './thong-ke-tong-tien-sv-theo-thang.component.html',
  styleUrls: ['./thong-ke-tong-tien-sv-theo-thang.component.scss'],
  providers: [
...
export class ThongKeTongTienSvTheoThangComponent implements OnInit {
  ...
  onSearch(){
    ...
    this.thongKeService.getThongKeTongTienSVTheoThang(date.getMonth()+1, date.getFullYear()).subscribe((data) => {
      console.log(data);
      this.dataList = data;
